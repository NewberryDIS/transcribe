    ...
    <Contentcss onClick={e => e.stopPropagation()}>
        <Closebutton onClick={() => setabout(false)} />
            ...
            <dl>
                ...
                <dd>Completed transcriptions can be accessed using the search box at the left on the Newberry Transcribe home page. Additionally, they will be at our digital collections site, where they can be searched and browsed. Access the in-progress collection here: <a href="https://collections.newberry.org/Share/5465d67708o0qorw52h84fx38w2as616" target="_blank" rel="noopener noreferrer">Transcribed manuscripts at Newberry Digital Collections</a>. Finally, to encourage digital scholarship projects, we have made the transcriptions available as a <a href="https://publications.newberry.org/transcribe/data/itemTranscriptions.json" target="_blank" rel="noopener noreferrer">JSON data set.</a> </dd>
