...
urllib.request.urlretrieve('http://digital.newberry.org/transcribe/omeka/api/items/', itemsFile)
# itemsFile2 = 'items2.json'
# urllib.request.urlretrieve('http://digital.newberry.org/api/items/?page=2', itemsFile2)
data = "" 
