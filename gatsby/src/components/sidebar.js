        ...
        `}>
            ...
            `}>
                ...
                <div className="bottomtext">
                    <span className="red">Please note:</span> Transcription status is currently updated once a day, so the "Transcribe/Not transcribed" page labels may be inaccurate. A fix is in the works -- thank you for your patience!
                </div>
            </CoreBox>
        </div>
    )
